...
Input contigs must be predicted as phage contigs by tools such as Virsorter2.
...
tar -xzvf fetchMG.tar.gz

Download checkv database
checkv download_database database/

Please download plasmid and plasmid-enriched Pfam from here.
